...
<?php echo $this->Html->link('Crear nueva mesa', array('controller' => 
 'mesas', 'action' => 'nuevo')) ?>
...
<table>
    ...
    <?php foreach($mesas as $mesa): ?>
        <tr>
            ...
            <td><?php echo $this->Html->link($mesa['Camarero']['nombre'] . ' ' . $mesa['Camarero']['apellido'],
                array('controller' => 'camareros', 'action' => 'ver', $mesa['Camarero']['id'])); ?></td>
             ...
             <td><?php echo $this->Form->postLink('Eliminar', array('action' => 'eliminar', 
                    $mesa['Mesa']['id']),array('confirm' => 'Eliminar mesa ' . $mesa['Mesa']['serie'] . '?'))?></td>
        </tr>
    <?php endforeach ?>
